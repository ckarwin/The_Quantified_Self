...
The four health parameters listed above are in essence the most general components that characterize one's holistic well-being. In future versions of the code, the health evaluation inputs should be developed further. In particular, users will have specific parameters that will best quantify thier overall well-being, e.g. they may be focused towards certain diseases such as diabetes, obesity, heart disease, etc. 
