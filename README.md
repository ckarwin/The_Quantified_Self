...
## Big Idea <br />
The concepts behind The Quantified Self are in essence the foundation of prevantative health care. The code is stil early in its beta phase, but it has potentail to significaly impact the nature of healthcare (i.e. treat the symptoms, etc.). 
